...
/**
 * This class is responsible for the actual construction of a PartTimeEmployee
 */
public class PartTimeEmployeeBuilder implements EmployeeBuilder{
    ...
    /**
     * Takes all the set EmployeeBuilder attributes and returns them set to a PartTimeEmployee
     * @return
     */
